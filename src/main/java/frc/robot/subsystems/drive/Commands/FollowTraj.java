...
public class FollowTraj extends Command {
  /** Creates a new FollowTraj. */
  private static final LoggedTunableNumber XkP =
      new LoggedTunableNumber("Traj/X/kP", AutoConstants.Gains.x.kP);

  private static final LoggedTunableNumber YkP =
      new LoggedTunableNumber("Traj/Y/kP", AutoConstants.Gains.y.kP);
  private static final LoggedTunableNumber headingkP =
      new LoggedTunableNumber("Traj/heading/kP", AutoConstants.Gains.heading.kP);

  private PIDController autoXPID = new PIDController(2, 0.0, 0.0);
  private PIDController autoYPID = new PIDController(2, 0.0, 0.0);
  private ProfiledPIDController trajHeading =
      new ProfiledPIDController(1.0, 0.0, 0.0, new Constraints(4.30, 3.99));
